...
public class ReadDimFromFile {
	public static int[] read(File file) throws IllegalArgumentException, NumberFormatException, FileNotFoundException {
		...
		//flco: dubbele try? niet zo erg ofzo, maar nesting gaat vrij diep
		try (Scanner sc = new Scanner(new FileReader(file))) {
			...
			try {
				...
				//flco: magic number, kan deze 4 eventueel een statische waarde krijgen? ik heb absoluut geen idee
				//wat dit is met gewoon jouw code te lezen
				if (dim >= 4) {
